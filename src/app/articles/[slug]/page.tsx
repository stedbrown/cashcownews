                    ...
                    <div className="col-span-12 lg:col-span-8">
                        <header className="mb-12">
                            ...
                            <div className="flex items-center justify-between py-6 border-y border-gray-100 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                                <div>BY THE AI MINER <span className="text-gray-200 ml-3 mr-3">|</span> {new Date(article.published_at).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</div>
                        ...
                        {article.image_url && (
                            <div className="mb-16">
                                ...
                                <span className="block mt-4 text-[10px] font-bold text-gray-400 italic text-right uppercase tracking-widest">
                                    Generated by DALL-E 3 for Cash Cow Intelligence
                                </span>
                            </div>
                        )}
